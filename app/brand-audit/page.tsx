...
export const metadata: Metadata = {
  title: 'Brand Audit — Madison | Humanitarians AI',
  description: 'Score every creative output against your locked brand constitution. CLEARED, DEFERRED, or REJECT — per constraint, with a reason. Build your brand\'s governed toolchain.',
}
          ...
          <div className="grid items-center gap-10 lg:grid-cols-3 lg:gap-12">
            <div className="space-y-6 lg:col-span-2">
              ...
              <div className="flex flex-col gap-3 min-[420px]:flex-row">
                ...
                <Link href="#audit" className="inline-flex h-11 items-center justify-center rounded-md border border-input bg-background px-6 text-sm font-semibold transition-colors hover:bg-muted">
                  See the brand audit
                </Link>
              </div>
            </div>
            ...
            <div className="rounded-lg border bg-muted p-6 md:p-8">
              ...
              <p className="mt-6 text-sm text-muted-foreground">
                No silent substitutions. No generic &ldquo;looks good.&rdquo; Every verdict is shown.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="audit" className="w-full bg-muted py-12 md:py-20">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-[760px] space-y-3">
            ...
            <h2 className="text-3xl font-bold tracking-tighter md:text-4xl">&ldquo;Is this on-brand?&rdquo; Answered, not asserted.</h2>
            <p className="text-lg text-muted-foreground">
          ...
          <div className="mt-8 rounded-lg border-l-4 border-primary bg-background p-6">
            ...
            <p className="mt-2 text-muted-foreground">
              Madison never swaps your palette, voice, or icon style because a generic convention says something else &ldquo;looks better.&rdquo; When a brief conflicts with a locked rule, Madison surfaces the conflict for human judgment.
            </p>
          </div>
        </div>
      </section>
